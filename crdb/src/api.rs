use crate::{CrdbFuture, Db, EventId, Lock, ObjectId, TypeId, Update, Updatedness};
use crdb_core::{CanDoCallbacks, ComboLock, ReadPermsChanges, ServerSideDb, User};
...
pub trait ApiConfig: 'static + Send + Sync + crate::private::Sealed {
    ...
    (
        ...
        impl $crate::ApiConfig for $typ {
            ...
            async fn create<D: $crate::Db>(
                ...
                use std::sync::Arc;
                use $crate::{Lock, Object, ResultExt, crdb_internal::crdb_helpers::parse_snapshot_ref};
            ...
            async fn recreate<D: $crate::Db>(
                ...
                use $crate::{Object, ResultExt, crdb_internal::crdb_helpers::parse_snapshot_ref, serde_json};
                use std::sync::Arc;
            ...
            fn get_users_who_can_read<'a, D: $crate::ServerSideDb, C: $crate::CanDoCallbacks>(
                ...
                use $crate::{Object, ResultExt, ServerSideDb, crdb_internal::crdb_helpers::parse_snapshot};
            ...
            async fn upload_object<'a, D: $crate::ServerSideDb, C: $crate::CanDoCallbacks>(
                ...
                use $crate::{Object, ResultExt, ServerSideDb, crdb_internal::crdb_helpers::parse_snapshot_ref, serde_json, UpdatesWithSnap, Update, UpdateData};
                use std::sync::Arc;

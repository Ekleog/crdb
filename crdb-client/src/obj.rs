...
// TODO(blocked): this could be explicitly generated by educe, but see https://github.com/magiclen/educe/issues/23
impl<T: Object, LocalDb: ClientSideDb> Clone for Obj<T, LocalDb> {
    fn clone(&self) -> Self {
        Self {
            ptr: self.ptr,
